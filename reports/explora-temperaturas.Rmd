...
Tendo que o São João ocorre no dia 24/06 e que a data da amostras corresponde a semana que passou, por exemplo, 10/01/1993 corresponde ao período 04/01 até 10/01 (intervalo=(D1,D2]),para responder essa pergunta vamos considerar todos os registros entre os dia 17/06 até 23/06

```{r}
climas %>% select(semana)
```
...
Com base no histograma apresentado acima, podemos perceber que ambas as cidades apresentam uma distribuição de volume de chuvas semanal semelhantes, sendo unimodal e assimétrica a direita.
